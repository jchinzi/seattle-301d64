...
function displayPics(){
  ...
  // When used inside a block, 'let' limits the variable's scope to that block (https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Statements/let). Therefore, while it did not throw an error when we used var, we do see an error from let because we are trying to access a variable that is limited to the scope of the while block.
  console.log(viewed);
